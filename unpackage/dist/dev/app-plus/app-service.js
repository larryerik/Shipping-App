  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "page" }, [
      vue.createElementVNode("view", { class: "header" }, [
        vue.createElementVNode("text", { class: "header-title" }, "发货作业台")
      ]),
        ...
        (vue.openBlock(true), vue.createElementBlock(
          ...
          vue.renderList($data.menus, (item) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              key: item.path,
              class: "menu-card",
              onClick: ($event) => $options.go(item.path)
            }, [
...
详细信息：${s4}`), (console["warn" === t4 ? "error" : t4] || console.log)(r3);
  ...
  const _sfc_main$3 = {
    ...
    methods: {
      ...
      toggleSkuSort() {
        ...
        const sorted = [...this.skuList].sort((a2, b2) => {
          return this.sortAsc ? a2.sku.localeCompare(b2.sku) : b2.sku.localeCompare(a2.sku);
        });
        this.skuList = sorted;
      },
      onSwipeClick(e2, fnsku) {
        if (e2.position === "right")
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "page" }, [
      vue.createElementVNode("view", { class: "top-bar" }, [
        ...
        vue.createElementVNode(
          "view",
          {
            class: vue.normalizeClass(["bt-status", { connected: $data.connectedDevice }])
          },
          vue.toDisplayString($data.connectedDevice ? `已连接：${$data.connectedDevice}` : "蓝牙未连接"),
          3
          /* TEXT, CLASS */
        ),
        vue.createElementVNode("view", {
          class: "connect-btn",
          onClick: _cache[1] || (_cache[1] = ($event) => $data.drawerVisible = true)
        }, "连接")
      ]),
      vue.createElementVNode("view", { class: "summary" }, [
        vue.createElementVNode(
          "text",
          null,
          "SKU: " + vue.toDisplayString($options.skuCount) + " 个",
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          ...
          {
            class: "sort-btn",
            onClick: _cache[2] || (_cache[2] = (...args) => $options.toggleSkuSort && $options.toggleSkuSort(...args))
          },
          vue.toDisplayString($options.skuSortLabel),
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          null,
          "数量: " + vue.toDisplayString($options.totalQty),
          1
          /* TEXT */
        )
      ]),
        ...
        vue.createVNode(_component_uni_swipe_action, null, {
          default: vue.withCtx(() => [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.skuList, (item, index) => {
                return vue.openBlock(), vue.createBlock(_component_uni_swipe_action_item, {
                  ...
                  onClick: ($event) => $options.onSwipeClick($event, item.fnsku)
                }, {
                  default: vue.withCtx(() => [
                    vue.createElementVNode("view", {
                      class: vue.normalizeClass(["swipe-main", { highlight: $data.highlightedIndex === index }]),
                      id: `sku-row-${index}`,
                      onClick: ($event) => $options.openQtyPopup(item)
                    }, [
                      vue.createElementVNode("view", { class: "left" }, [
                        ...
                        vue.createElementVNode(
                          "text",
                          { class: "barcode" },
                          vue.toDisplayString(item.fnsku),
                          1
                          /* TEXT */
                        )
                      ]),
      ...
      vue.createElementVNode("view", { class: "bottom-panel" }, [
        vue.createElementVNode("view", { class: "field-row" }, [
          ...
          vue.withDirectives(vue.createElementVNode(
            "input",
            {
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.boxId = $event),
              class: "input",
              placeholder: "箱号"
            },
            null,
            ...
            [vue.vModelText, $data.boxId]
          ])
        ]),
        vue.createElementVNode("view", { class: "action-row" }, [
          vue.createElementVNode("view", {
            class: "btn primary",
            onClick: _cache[5] || (_cache[5] = (...args) => $options.scanGoods && $options.scanGoods(...args))
          }, "扫码"),
          vue.createElementVNode("view", {
            class: "btn",
            onClick: _cache[6] || (_cache[6] = (...args) => $options.clearAll && $options.clearAll(...args))
          }, "清空"),
          vue.createElementVNode("view", {
            class: "btn",
            onClick: _cache[7] || (_cache[7] = (...args) => $options.updateData && $options.updateData(...args))
          }, "更新"),
          vue.createElementVNode("view", {
            class: "btn accent",
            onClick: _cache[8] || (_cache[8] = (...args) => $options.printOptions && $options.printOptions(...args))
          }, "打印")
        ])
      ]),
      $data.drawerVisible ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "mask",
        onClick: _cache[9] || (_cache[9] = ($event) => $data.drawerVisible = false)
      })) : vue.createCommentVNode("v-if", true),
      vue.createElementVNode(
        "view",
        {
          class: vue.normalizeClass(["drawer", { show: $data.drawerVisible }])
        },
        [
          vue.createElementVNode("view", { class: "drawer-title" }, "扫描到的蓝牙设备"),
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($data.btDevices, (item) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                key: item.id,
                class: "device-item",
                onClick: ($event) => $options.connectDevice(item.name)
              }, [
                vue.createElementVNode(
                  "text",
                  null,
      ...
      $data.qtyPopupVisible ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "mask",
        onClick: _cache[10] || (_cache[10] = (...args) => $options.closeQtyPopup && $options.closeQtyPopup(...args))
      })) : vue.createCommentVNode("v-if", true),
      $data.qtyPopupVisible ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
        class: "qty-popup"
        ...
        vue.createElementVNode(
          "view",
          { class: "popup-title" },
          vue.toDisplayString($data.qtyPopupMode === "scanAdd" ? `输入数量：${$data.editingTitle}` : `修改 ${$data.editingTitle}`),
          1
          /* TEXT */
        ),
        vue.withDirectives(vue.createElementVNode("input", {
          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => $data.editingQty = $event),
          type: "number",
          class: "popup-input",
          placeholder: `${$data.editingOldQty}`,
          focus: $data.qtyInputFocus,
          onBlur: _cache[12] || (_cache[12] = ($event) => $data.qtyInputFocus = false)
        }, null, 40, ["placeholder", "focus"]), [
          [vue.vModelText, $data.editingQty]
        ]),
        vue.createElementVNode("view", { class: "popup-actions" }, [
          vue.createElementVNode("view", {
            class: "popup-btn",
            onClick: _cache[13] || (_cache[13] = (...args) => $options.closeQtyPopup && $options.closeQtyPopup(...args))
          }, "取消"),
          vue.createElementVNode("view", {
            class: "popup-btn ok",
            onClick: _cache[14] || (_cache[14] = (...args) => $options.confirmQty && $options.confirmQty(...args))
          }, "确定")
        ])
      ])) : vue.createCommentVNode("v-if", true)
    ]);
  ...
  const _sfc_main$2 = {
    ...
    computed: {
      ...
      totalWeight() {
        const n2 = this.boxes.reduce((sum, item) => sum + Number(item.weight || 0), 0);
        return n2.toFixed(1);
      }
    },
    methods: {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "page" }, [
      vue.createElementVNode("view", { class: "table-head" }, [
        vue.createElementVNode("text", { class: "head-cell" }, "序号"),
        vue.createElementVNode("text", { class: "head-cell" }, "数量"),
        vue.createElementVNode("text", { class: "head-cell" }, "重量"),
        vue.createElementVNode("text", { class: "head-cell" }, "箱号"),
        vue.createElementVNode("text", { class: "head-cell head-action" }, "操作")
      ]),
      vue.createElementVNode("scroll-view", {
        "scroll-y": "",
        class: "list-wrap"
        ...
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($data.boxes, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              key: item.id,
              class: "row",
              onClick: ($event) => $options.showBoxDetail(item)
            }, [
              vue.createElementVNode(
                "text",
                { class: "cell seq" },
              ...
              vue.createElementVNode(
                "text",
                { class: "cell" },
                vue.toDisplayString(item.weight) + "kg",
                1
                /* TEXT */
              ),
              vue.createElementVNode(
              ...
              vue.createElementVNode("text", {
                class: "cell action",
                onClick: vue.withModifiers(($event) => $options.removeBox(item.id), ["stop"])
              }, "删除", 8, ["onClick"])
            ], 8, ["onClick"]);
          }),
          128
      ...
      vue.createElementVNode("view", { class: "stats" }, [
        vue.createElementVNode(
          "text",
          null,
          "总箱数: " + vue.toDisplayString($options.totalBox),
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          null,
          "总数量: " + vue.toDisplayString($options.totalQty),
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          null,
          "总重量: " + vue.toDisplayString($options.totalWeight) + "kg",
          1
          /* TEXT */
        )
      ]),
      vue.createElementVNode("view", { class: "bottom-actions" }, [
        vue.createElementVNode("view", {
          class: "btn primary",
          onClick: _cache[0] || (_cache[0] = (...args) => $options.scanBox && $options.scanBox(...args))
        }, "扫码"),
        vue.createElementVNode("view", {
          class: "btn",
        ...
        vue.createElementVNode("view", {
          class: "btn accent",
          onClick: _cache[2] || (_cache[2] = (...args) => $options.operateOptions && $options.operateOptions(...args))
        }, "操作")
      ]),
      $data.detailVisible ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "mask",
        onClick: _cache[3] || (_cache[3] = ($event) => $data.detailVisible = false)
      })) : vue.createCommentVNode("v-if", true),
      $data.detailVisible ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "detail-popup"
        ...
        vue.createElementVNode(
          "view",
          { class: "title" },
          "整箱详情 - " + vue.toDisplayString($data.currentBox.boxNo || "无箱号"),
          1
          /* TEXT */
        ),
        vue.createElementVNode("view", { class: "detail-body" }, [
          $data.currentBox.details && $data.currentBox.details.length ? (vue.openBlock(), vue.createElementBlock("scroll-view", {
            key: 0,
            "scroll-y": "",
            class: "detail-list"
          }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.currentBox.details, (line, idx) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  key: `${line.sku}-${idx}`,
                  class: "detail-line"
                }, [
        ...
        vue.createElementVNode("view", {
          class: "close-btn",
          onClick: _cache[4] || (_cache[4] = ($event) => $data.detailVisible = false)
        }, " 关闭 ")
      ])) : vue.createCommentVNode("v-if", true)
    ]);
  }
      ...
      $options.showHistoryPanel ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        vue.createElementVNode("view", { class: "tags" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($data.histories, (item) => {
